...
const StyleVariant: Record<DropdownStyleVariant, DropdownStyle> = {
    ...
    modSlot: {
        button: "select-none font-roboto z-20 sm:w-8 md:w-10 lg:w-13 text-xs h-8 justify-between rounded-md px-2 py-2 text-left shadow-sm flex items-center gap-2 bg-neutral-800 text-white border border-zinc-600 cursor-pointer",
        list: "select-none absolute font-roboto z-50 top-full sm:w-8 md:w-10 lg:w-13 text-xs rounded-md bg-neutral-800 text-white border border-zinc-600",
