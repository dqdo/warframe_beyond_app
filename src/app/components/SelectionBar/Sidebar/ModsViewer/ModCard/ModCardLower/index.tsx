    ...
    return (
        <div className="pointer-events-none relative">
            <Image src={`/images/mods/cards/${frameColor}FrameBottom.png`} alt="Bottom Frame" width={200} height={200} loading="lazy"
                className={`z-2 relative transition-all duration-100 ease-in-out ${(expandAll || hover) ? 'mt-[150px]' : '-mt-[25px]'}`} />

            {(expandAll || hover) && (
                <div className="absolute top-[35px] left-1/2 -translate-x-1/2 w-[145px] h-full ">
            ...
            {currentRank == mod.fusionLimit && (
                <hr className="absolute bottom-[18px] left-1/2 -translate-x-1/2 w-[65%] border-t-[0.1rem] border-[#a6e6ff] z-3" />
            )}

            <div className="absolute bottom-[13px] left-1/2 -translate-x-1/2 w-[65%] flex justify-center text-[0.5rem] z-4 gap-0.5">
